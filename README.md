...
При переносе проекта на другие FPGA необходимо учитывать полярность тактирования встроенной памяти: у Altera она отрицательная (по спаду), у Gowin, Xilinx положительная (по фронту).
